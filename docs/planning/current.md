...
- [•] `document-center` 文档主档与版本链基础能力：待提交第二项后启动。
...
- [•] 准备提交第二批第二项，然后启动第三项 `document-center` 文档主档与版本链基础能力。
...
- 提交第二批第二项 `contract-core` 合同主档与编辑基础能力；提交后启动第三项 `document-center` 文档主档与版本链基础能力。
