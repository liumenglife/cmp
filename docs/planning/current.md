...
- [•] `workflow-engine` 审批定义与平台运行时基础能力：待提交第三项后启动。
- [ ] 合同文档挂接闭环。
- [ ] 审批发起、审批承接与合同状态回写闭环。
- [ ] 第二批最小端到端闭环验证。
...
- [•] 准备提交第二批第三项，然后启动第四项 `workflow-engine` 审批定义与平台运行时基础能力。
...
- 提交第二批第三项 `document-center` 文档主档与版本链基础能力；提交后启动第四项 `workflow-engine` 审批定义与平台运行时基础能力。
