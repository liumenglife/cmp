create table ia_ai_application_job (
    ...
    unique key uk_ai_job_idempotency (application_type, contract_id, idempotency_key)
);
...
create table ia_ai_context_envelope (
    ...
    degradation_action_json text not null,
...
create table ia_ai_application_result (
    ...
    citation_list_json text not null,
    ...
    risk_flag_list_json text not null,
    created_at timestamp not null
);
