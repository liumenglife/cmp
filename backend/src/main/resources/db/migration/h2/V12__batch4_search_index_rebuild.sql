create table ia_search_source_envelope (
    ...
    source_anchor_json clob not null,
    title_text varchar(512) not null,
    body_text clob not null,
    keyword_text clob not null,
...
create table ia_search_document (
    ...
    sort_payload_json clob not null,
    locale_code varchar(20) not null,
    visibility_scope_json clob not null,
...
create table ia_search_result_set (
    ...
    search_query_json clob not null,
    result_status varchar(40) not null,
    item_payload_json clob not null,
    facet_payload_json clob not null,
